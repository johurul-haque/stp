...
export function SearchInput() {
  ...
  return (
    <div className={groupStyles()}>
      <label htmlFor="query" className="pl-3 py-2">
        <SearchIcon
      ...
      <input
        ...
        className="w-full border-0 outline-none bg-transparent placeholder:text-neutral-500 dark:placeholder:text-neutral-400 py-2"
