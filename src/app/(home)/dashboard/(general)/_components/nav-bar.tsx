...
export function NavBar() {
  ...
  return (
    <nav className="inline-flex items-center justify-center rounded-md bg-[hsl(240_4.8%_95.9%)] dark:bg-neutral-800 p-1 dark:text-[hsl(240_5%_64.9%)] text-[hsl(240_3.8%_46.1%)]">
